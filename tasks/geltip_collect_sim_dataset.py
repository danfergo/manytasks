...
from components.printer_extended.printer_extended import PrinterExtended
...
def geltip_collect_sim_dataset():
    obj_xyaxes_map = {
        'cone': '1 0 0 0 1 0',
        'sphere': '1 0 0 0 1 0',
        ...
        Platform.create({
            ...
            'environments': {
                ...
                'real': {
                    ...
                    'interfaces': {
                        '/printer/printer': {
                            'serial_path': '/dev/ttyUSB0'  # check this matches the real ports
                        },
                        '/printer': {
                            'serial_path': '/dev/ttyUSB1'  # check this matches the real ports
                        },
                        '/geltip': {
                            'cam_id': 2
                        }
